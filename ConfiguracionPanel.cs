    ...
    public class ConfiguracionPanel : UserControl
    {
        ...
        private void InicializarComponentes()
        {
            ...
            btnGuardar.Click += (s, e) =>
            {
                ...
                nueva.Resolucion = comboResolucion.SelectedItem?.ToString() ?? "1280x720";
                ...
                MusicManager.ActualizarVolumen(nueva.VolumenMusica);
...
//Menú de configuración del usuario. Usa y modifica "GameSettings", permite elegir resolución, volumen, tema y pantalla completa. Como tambien aplicar cambios en tiempo real a través de "GameStateManager". 