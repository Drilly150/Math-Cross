...
namespace MathCross
{
    public static class GameStateManager
    {
        ...
        public static GameSettings Configuracion { get; private set; } = new GameSettings();
        ...
        public static void MostrarControl(Control nuevo)
        {
            if (contenedor.Controls.Count > 0)
                historial.Push(contenedor.Controls[0]);
...
//Este archivo unifica todo los menus que abarca el juego en cuestión. Controla la transición entre pantallas (MainMenu, LevelSelectMenu, PuzzleGamePanel, etc.) Carga la configuracion "GameSettings" y la aplica al arrancar. Tambien guarda si estás en modo práctica, qué nivel está activo, y el historial de navegación.